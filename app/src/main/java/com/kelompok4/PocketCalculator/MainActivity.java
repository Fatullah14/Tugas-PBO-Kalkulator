package com.kelompok4.PocketCalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void btn_00(View view) {
        user_input.setText(user_input.getText() + "00");
    }
    ...
    public void btn_mod(View view) {
        sign = "modulus";
        val_1 = user_input.getText().toString();
        user_input.setText(null);
        sign_Box.setText(val_1 + " mod");
        has_Dot = false;
    }
        ...
        if (sign == null) {
            ...
            switch (sign) {
                ...
                case "sin":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText(Math.sin(Math.toRadians(num1)) + "");
                    sign = null;
                    sign_Box.setText("sin " + val_1);
                    break;
                case "cos":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText(Math.cos(Math.toRadians(num1)) + "");
                    sign = null;
                    sign_Box.setText("cos " + val_1);
                    break;
                case "tan":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText(Math.tan(Math.toRadians(num1)) + "");
                    sign = null;
                    sign_Box.setText("tan " + val_1);
                    break;
                case "+":
                    val_2 = user_input.getText().toString();
                    num1 = Double.parseDouble(val_1);
                ...
                case "modulus":
                    ...
                    user_input.setText(answer + "");
                    sign = null;
                    sign_Box.setText(val_1 + " mod " + val_2);
                    break;
            }
